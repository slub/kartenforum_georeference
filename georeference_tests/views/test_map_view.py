...
def test_GET_MapView_success(testapp, dbsession):
...
def test_GET_MapView_failure(testapp):
...
def test_POST_MapView_failure_invalid_json(testapp, dbsession):
    ...
    res = testapp.post(ROUTE_PREFIX + '/map_view/', params=json.dumps(params), content_type='application/json; charset=utf-8', status=400)
...
def test_POST_MapView_success(testapp, dbsession):
    ...
    res = testapp.post(ROUTE_PREFIX + '/map_view/', params=json.dumps(params), content_type='application/json; charset=utf-8', status=200)

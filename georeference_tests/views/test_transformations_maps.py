...
def test_POST_TransformationForMapId_success_newTransformationMultiplyTimes(testapp, dbsession):
    map_id = 10001558
...
def test_POST_TransformationForMapId_success_newTransformationWithoutClip(testapp, dbsession):
    map_id = 10001558
